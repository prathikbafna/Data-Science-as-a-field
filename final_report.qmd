...
* If a person was diagnosed prior to 2005, did they relapse/have cancer spread more than those who were diagnosed after 2005? ***[@noauthor_recurrent_2016]***
...
![Chemotherapy vs Status](./images/chemo.jpeg)
...
![Smoking Status vs Last Follow Up Date](./images/smoking-follow.jpeg)
...
![Heatmap of Diagnosis Type and Dosage](./images/diagnosis.jpeg)

##### Figure 4:

In Figure 4 we analyze what sort of treatments did the patient receive and their smoking status. We visualize this data in a tabular format.
